 ...
 * gicv2.c
 *
 * intcon_gic.c for the Zynq, Allwinner H3, Allwinner H5, and the Fire3
 *
 * Tom Trebisky  1/19/2017
 * Tom Trebisky  11/15/2024 12/30/2025
 *
 ...
 *  This code seems fine with that also.
 *
...
#ifdef BOARD_FIRE3
/* For Fire3 (Samsung xxx) */
#define GIC_DIST_BASE   ((struct gic_dist *) 0xc0009000)
#define GIC_CPU_BASE    ((struct gic_cpu *) 0xc000a000)
#endif
