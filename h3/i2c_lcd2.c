/* Notes by Tom T 8-1-2020
 * From: https://github.com/fm4dd/i2c-lcd
 *   pcf8574-lcd-demo.c
 *
 * This made me nuts until I did two things:
 *  1) I set it up to run from 5 volts rather than 3.3
 *    (using a level shifter).
 *  2) I turned the contrast pot on the back of the device.
 *
 * Working 8-2-2020 with the H3 based Orange Pi
 */
